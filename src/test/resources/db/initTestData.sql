...
values (default, 'Music', 3);
insert into faculties (id, name, duration)
values (default, 'Math sciences', 4);
insert into faculties (id, name, duration)
values (default, 'Hacking', 5);
insert into faculties (id, name, duration)
values (default, 'Management', 4);

insert into groups (id, name, faculty_id)
values (default, '11-AA', 1);
insert into groups (id, name, faculty_id)
values (default, '11-AB', 1);
insert into groups (id, name, faculty_id)
values (default, '12-AA', 2);
insert into groups (id, name, faculty_id)
values (default, '13-AA', 3);
insert into groups (id, name, faculty_id)
values (default, '13-AB', 3);
insert into groups (id, name, faculty_id)
values (default, '13-AC', 3);
insert into groups (id, name, faculty_id)
values (default, '14-AC', 4);
insert into groups (id, name, faculty_id)
values (default, '14-AB', 4);

insert into subjects (id, name, description)
values (default, 'Mathematics', 'Mathematicians have always been fascinated by numbers.');
insert into subjects (id, name, description)
...
insert into subjects (id, name, description)
values (default, 'Engineering Science',
        'Engineering Science encompasses a vast range of subjects, from microelectronics to offshore oil platforms.');
insert into subjects (id, name, description)
values (default, 'Law', 'Studying law will not only give you the opportunity to qualify as a solicitor or barrister.');
insert into subjects (id, name, description)
values (default, 'Modern Languages',
        'Studying Modern Languages provides both practical training in written and spoken language. have always been fascinated by numbers.');
insert into subjects (id, name, description)
values (default, 'Cyber protection', 'The science about backdoors.');
...
values (1, 60, 6, 'Web Development Fundamentals', '2023-02-22 00:33:02.716164', 4, 4),
       ...
       (11, 30, 5, 'Artificial Intelligence and Machine Learning', '2023-03-11 22:33:02.762680', 4, 2);
